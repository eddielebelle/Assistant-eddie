...
class translator:
    def __init__(self, client_id='interface', mqtt_host=None, mqtt_port=None, mqtt_username=None,
        ...
        self.mqtt_client.subscribe('clock/out')
    ...
    def clock_chain(self, data):
        reply = self.clocky.run(data)
        print(reply)
        self.mqtt_client.publish('vits/in', reply)
    ...
    def on_message(self, client, userdata, message):
        ...
        print(message.topic,' msg received')
        ...
        if message.topic == 'clock/out':
            self.clock_chain(data)
